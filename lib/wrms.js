...
const WRMS = function(params) {
  ...
  this.organisation = {
    get: id => {
      ...
      return this.defaultApiCall(`api/v3/organisation/${id}`, options);
    },

    query: params => {
      // Eg: api/v3/organisation?name=Catalyst+IT
      let options = this.defaultRequestOptions();
      options = {
        ...options,
        ...{
      ...
      return this.defaultApiCall("api/v3/organisation", options);
    },
  ...
  this.system = {
    get: id => {
      ...
      return this.defaultApiCall(`api/v3/system/${id}`, options);
    },

    query: params => {
      // Eg: api/v3/system?system_desc=Work+Request+Management+System
      let options = this.defaultRequestOptions();
      options = {
        ...options,
        ...{
      ...
      return this.defaultApiCall("api/v3/system", options);
    },
